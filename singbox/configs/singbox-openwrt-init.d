...
# github.com/rezconf/Sing-box/wiki/How-to-Run

# These packages should be installed:
# opkg update && opkg install kmod-inet-diag kmod-netlink-diag kmod-tun zsh curl htop vim
...
start_service() {
    ...
    sleep 5
    # if /usr/bin/curl -f -s -m10 -x localhost:2080 https://ipinfo.io; then
    #     echo "curl ipinfo.io success!"
        # /usr/sbin/iptables -I FORWARD -o tun0 -j ACCEPT
    # else
    #     echo "curl ipinfo.io failed! Restarting wifi"
